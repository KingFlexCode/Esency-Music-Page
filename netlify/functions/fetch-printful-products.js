...
export async function handler() {
  ...
  // ✅ Correct endpoint that includes your store_id
  ...
  try {
    ...
    // ✅ Expected structure: { code: 200, result: [...] }
    ...
    // ✅ Simplify for your merch page
    const products = data.result.map((p) => ({
      id: p.id,
      name: p.name,
      thumbnail_url: p.thumbnail_url,
      price: 35.0, // placeholder until we fetch variant details
      sizes: ["S", "M", "L", "XL", "XXL"],
    }));
